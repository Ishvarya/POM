...
public class activateUser {
  ...
  public void activateUsers() {
	  ...
	  Reporter.log("The first two users have been activated");
  }
  
  @Test(priority = 3, dependsOnMethods = {"activateUsers"}, groups= {"Smoke Testing"})
  public void logOut() {
	  //Call utility function
	  util.waitForPageLoad(driver);
	  util._logOut(driver);
  ...
  public void beforeClass() {
	  Reporter.log("Start of activateUser class");
  }

  @AfterClass
  public void afterClass() {
	  Reporter.log("End of activateUser class");
  }
