...
public class utilFunctions {
	// now running the auto-tests on there own server
	public String _url = "https://ber-col-002.prea.local/220144/login.html";
	
	//0. Provide Login Credentials
	...
	public WebDriver selectBrowser(String browserType) {
		if(browserType.equals("Firefox")) {
			  ...
			  System.setProperty("webdriver.gecko.driver", "C:\\Users\\ishvarya\\Selenium\\SeleniumDrivers\\geckodriver.exe");	
			  //System.setProperty("webdriver.gecko.driver", "C:\\Users\\Daniel\\Desktop\\PREA\\DEV\\UTILS\\Selenium\\SeleniumDrivers\\geckodriver-v0.23.0-win64\\geckodriver.exe");
			  ...
			  //System.setProperty("webdriver.chrome.driver", "C:\\Users\\Daniel\\Desktop\\PREA\\DEV\\UTILS\\Selenium\\SeleniumDrivers\\chromedriver_win32\\chromedriver.exe");
			  ...
			  System.setProperty("webdriver.ie.driver", "C:\\Users\\Daniel\\Desktop\\PREA\\DEV\\UTILS\\Selenium\\SeleniumDrivers\\IEDriverServer_Win32_3.9.0\\IEDriverServer.exe");
	...
	public void _logIn(String sUsername, String sPassword,WebDriver driver) {
		  ...
		  WebElement loginButton = driver.findElement(By.xpath("//*[@id=\"login_submit\"]/input"));
		  loginButton.click();
